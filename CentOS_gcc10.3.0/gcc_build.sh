...
# Target linux/gnu
build_target=x86_64-centos7-linux-gnu
...
# GCC 10.3.0
export gcc_src_root=$srcroot/gcc-10.3.0
export gcc_install_root=$installroot/gcc/install
install_dir=$gcc_install_root
build_dir=$gcc_install_root/../build
source_dir=$gcc_src_root
tarfile_dir=$gcc_src_root/../source_code/gcc-${gcc_version}_tarfile
